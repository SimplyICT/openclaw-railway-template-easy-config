-- Version 4: Multi-Site Compliance Schema
...
CREATE TABLE IF NOT EXISTS audit_entries (
    ...
    site_name TEXT REFERENCES sites(site_name), -- Track which site this audit happened at
...
CREATE INDEX IF NOT EXISTS idx_audit_site ON audit_entries(site_name);
